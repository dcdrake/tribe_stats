...
for season in range(13,16):
    ...
    for i in range(0, 100):
            ...
            player_page_url = 'http://www.tribeathletics.com/custompages/files/mbb/20%d/stats/plyr_%02d.htm' % (season, i)
            ...
            if (page.status_code != 404):
                ...
                for game in player_info:
                    ...
                    if (beginning_of_date_index_exists):
                        ...
                        # Check the first element of the game and exclude the line if it's not a date.
                        if not (len(game) < 4) and '/' in game[0]:
                            date_string = game[0]
